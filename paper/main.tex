...
Thus, conditional on the PSLT two-center projection data and with all additional SM-charged sectors either absent from the kernel or fully paired by a gauge-invariant mass map, the theory has exactly three low-energy chiral SM generations and no unpaired light SM-charged exotics.
