...
The scalar two-center spectral operator and the quantities \((g_N,\Gamma_N,B_N,P_N)\) then define an effective model for how these three protected modes form and couple to the visible sector.
